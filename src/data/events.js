...
export const EVENT_POOLS = {
  ...
  river_valley: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: 'Talk your way past', dc: 12, ok: 'They accept your story.', bad: 'They insist on a spot inspection. Wear is likely.', wear: 1, addsRep: { key: 'nwmp', delta: 0 }, branch: () => ({
          id: 'nwmp_detain',
    ...
    },
    {
      ...
      text: 'A Métis hunter sits on his cart at the river crossing, mending a rifle sling. He has spare ammunition — shot and ball wrapped in a leather belt — and he is willing to part with it. Ammunition was precious on the trail, and traders who carried spare were the most welcome sight on the prairie.',
      classification: 'Supply Find',
  ...
  wooded: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: 'Call for help', dc: 9, ok: 'A nearby Métis party rights the cart swiftly. They share a laugh and some pemmican.', bad: 'Helpers arrive slow and grumpy.', morale: 3, addsRep: { key: 'metis', delta: 1 }, time: 1, give: [{ name: 'Pemmican Rations', amt: 1 }] }
      ]
    },
    {
  ...
  // Settlement-specific events — triggered when arriving at a settlement
export const SETTLEMENT_EVENTS = {
  ...
  metis: [
    {
      id: 'metis_welcome',
      text: 'The Métis camp has been expecting you — news travels fast along the trail. Before the cart fully stops, children are running alongside and a woman is already lifting the lid off a pot of rubaboo. The smell of onions and grease and prairie herbs. Someone tunes a fiddle.',
...
export function getSettlementEvents(settlementType) {
  return SETTLEMENT_EVENTS[settlementType] || SETTLEMENT_EVENTS.hbc || [];
}

export function pickSettlementEvent(settlementType, rng) {
